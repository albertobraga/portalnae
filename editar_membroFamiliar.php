...
<div class="container theme-showcase" role="main">
	<div class="page-header">
		<h1>Editar Item de Renda</h1>
	</div>
	<div class="row espaco">
		<div class="pull-right">
			<a href='listar_itemRendaporCandidatura.php?idCandidatura=<?php echo $resultado['candidatura_id'];?>'><button type='button' class='btn btn-info'>Retornar</button></a>			
		</div>
	</div>
	...
	<div class="row">
		<div class="col-md-12">
			<form class="form-horizontal" method = "POST" action = "processa/proc_edit_renda.php">
				...
				<div class="form-group">
				<label for="inputPassword3" class="col-sm-2 control-label">Total Renda</label>
					<div class="col-sm-10">
