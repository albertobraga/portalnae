...
if($_SERVER['REQUEST_METHOD']=='POST'){
	...
	<?php }elseif(!isset($_SESSION['ultimo_id_aluno'])){
		...
		header('Location: listar_candidatos_homologacao.php');	
	}
} ?>
		...
		<div class="col-md-12">        
			<fieldset>
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input type="text" readonly="readonly"  class="form-control" id="dataHomologacao" name=dataHomologacao placeholder="" value="<?php echo $resultado['dataHomologacao'];?>" />
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-2"><?php $result_estadoCivil_2 = mysqli_query($conectar,"SELECT id, descritor FROM estadoCivil");?>
						<select id="estadoCivil_id"  readonly="readonly"  class="form-control" name="estadoCivil_id"><?php foreach($result_estadoCivil_2 as $restadoCivil_2): ?>
			...
			<fieldset>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<select id="nomeBanco"  readonly="readonly"  name="nomeBanco" class="form-control">
			...
			<fieldset>
				...
				<div class="form-group">
					...
					<div class="col-sm-2">
						<select id="uf" name="uf" readonly="readonly" class="form-control">
