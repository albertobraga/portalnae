...
<div class="container theme-showcase" role="main">
	<div class="page-header">
		<h1>Visualizar Candidado</h1>
	</div>
	<div class="row">
		<div class="pull-right">
			<a href='listar_candidatos.php'><button type='button' class='btn btn-info'>Retornar</button></a>			
		</div>
	</div>
		...
		<div class="col-md-12">        
			<fieldset>
				...
				<form class="form-horizontal" method = "POST" action="">
					...
					<div class="form-group">
						<label for="inputEmail3" class="col-sm-2 control-label">Telefone Resindecial</label>
						<div class="col-sm-4">
