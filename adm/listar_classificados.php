					...
					<tbody>
						<?php while($linhas = mysqli_fetch_array($resultado)){
							echo "<tr>";
								...
								<td>
									<a href="visualizarClassificado.php?idCandidatura=<?php echo $linhas['id'];?>">
									<button type='button' class='btn btn-primary'>Visualizar</button></a>
								</td>
							<?php echo "</tr>";
						} ?>
					</tbody>
